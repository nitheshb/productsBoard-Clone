  ...
  const menuItems = [
    {
      ...
      label: 'Search',
      icon: (
        <svg height="16px" width="16px" viewBox="0 0 16 16" role="img" aria-label="SearchIcon" className="sc-fQpRED bUGbIN ui-icon"><path fill="currentColor" fill-rule="evenodd" d="M6.667 2.75a3.917 3.917 0 1 0 0 7.833 3.917 3.917 0 0 0 0-7.833M1.25 6.667a5.417 5.417 0 1 1 9.74 3.263l3.54 3.54a.75.75 0 1 1-1.06 1.06l-3.54-3.54a5.417 5.417 0 0 1-8.68-4.324" clip-rule="evenodd"></path></svg>
      )
    },
    {
      id: 'home',
    ...
    },
    {
      ...
      label: 'Products',
      icon: (
        <svg height="16px" width="16px" viewBox="0 0 16 16" role="img" aria-label="ProductIcon" className="sc-fQpRED bUGbIN ui-icon"><path fill="currentColor" fill-rule="evenodd" d="M1.25 4A2.75 2.75 0 0 1 4 1.25h8A2.75 2.75 0 0 1 14.75 4v8A2.75 2.75 0 0 1 12 14.75H4A2.75 2.75 0 0 1 1.25 12zM4 2.75c-.69 0-1.25.56-1.25 1.25v1.25h10.5V4c0-.69-.56-1.25-1.25-1.25zm9.25 4H2.75V12c0 .69.56 1.25 1.25 1.25h8c.69 0 1.25-.56 1.25-1.25z" clip-rule="evenodd"></path></svg>
      )
    },
    {
      id: 'portals',
      label: 'Portals',
      icon: (
        <svg height="16px" width="16px" viewBox="0 0 16 16" role="img" aria-label="PortalIcon" className="sc-fQpRED bUGbIN ui-icon"><path fill="currentColor" fill-rule="evenodd" d="M8 2.083a5.917 5.917 0 1 0 0 11.834A5.917 5.917 0 0 0 8 2.083M.583 8a7.417 7.417 0 1 1 14.834 0A7.417 7.417 0 0 1 .583 8m9.058-1.64-2.461.82-.82 2.46 2.46-.82zm.382-1.697c.125-.03.373-.078.64.017.307.11.548.35.657.656.096.268.046.516.017.64-.03.13-.08.28-.128.423l-.008.023-.992 2.976-.005.017c-.021.065-.07.214-.16.346q-.116.168-.282.283a1.4 1.4 0 0 1-.364.165l-2.975.992-.024.008a5 5 0 0 1-.422.128c-.125.03-.373.078-.64-.017a1.08 1.08 0 0 1-.657-.656 1.1 1.1 0 0 1-.017-.64c.03-.13.081-.281.128-.423l.008-.023.992-2.976.006-.017c.02-.065.069-.214.16-.346q.113-.168.282-.283c.132-.09.281-.139.346-.16l.018-.005 2.975-.992.023-.008a5 5 0 0 1 .422-.128" clip-rule="evenodd"></path></svg>
      )
    },
    {
      id: 'more',
