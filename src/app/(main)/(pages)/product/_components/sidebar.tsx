...
const Sidebar = () => {
  ...
  const menuItems = [
    ...
    },
    {
      ...
      label: 'Products',
      icon: (
        <svg height="16px" width="16px" viewBox="0 0 16 16" role="img" aria-label="ProductIcon" className="ui-icon"><path fill="currentColor" fillRule="evenodd" d="M1.25 4A2.75 2.75 0 0 1 4 1.25h8A2.75 2.75 0 0 1 14.75 4v8A2.75 2.75 0 0 1 12 14.75H4A2.75 2.75 0 0 1 1.25 12zM4 2.75c-.69 0-1.25.56-1.25 1.25v1.25h10.5V4c0-.69-.56-1.25-1.25-1.25zm9.25 4H2.75V12c0 .69.56 1.25 1.25 1.25h8c.69 0 1.25-.56 1.25-1.25z" clipRule="evenodd"></path></svg>
      )
    },
    {
      id: 'portals',
      label: 'Portals',
      icon: (
        <svg height="16px" width="16px" viewBox="0 0 16 16" role="img" aria-label="PortalIcon" className="ui-icon"><path fill="currentColor" fillRule="evenodd" d="M8 2.083a5.917 5.917 0 1 0 0 11.834A5.917 5.917 0 0 0 8 2.083M.583 8a7.417 7.417 0 1 1 14.834 0A7.417 7.417 0 0 1 .583 8m9.058-1.64-2.461.82-.82 2.46 2.46-.82zm.382-1.697c.125-.03.373-.078.64.017.307.11.548.35.657.656.096.268.046.516.017.64-.03.13-.08.28-.128.423l-.008.023-.992 2.976-.005.017c-.021.065-.07.214-.16.346q-.116.168-.282.283a1.4 1.4 0 0 1-.364.165l-2.975.992-.024.008a5 5 0 0 1-.422.128c-.125.03-.373.078-.64-.017a1.08 1.08 0 0 1-.657-.656 1.1 1.1 0 0 1-.017-.64c.03-.13.081-.281.128-.423l.008-.023.992-2.976.006-.017c.02-.065.069-.214.16-.346q.113-.168.282-.283c.132-.09.281-.139.346-.16l.018-.005 2.975-.992.023-.008a5 5 0 0 1 .422-.128" clipRule="evenodd"></path></svg>
      )
    },
    {
      id: 'more',
  ...
  return (
    <div className="flex h-screen relative">
      {/* Main Sidebar */}
      <div className="flex flex-col items-center w-16 h-screen bg-gray-50 border-r border-gray-200 z-10">
        {/* Logo */}
        <div className="mt-4 mb-6">
          <div className="w-8 h-8">
            <svg height="16px" viewBox="0 0 162 108" data-testid="AppHeader-Logo" data-nc="true">
              <path fill="#0071E1" d="M108.001 0L162 54l-54.001 54-53.996-54L108 0z"></path>
              <path fill="#FFC600" d="M107.997 0L53.999 54 0 0h107.997z"></path>
              <path fill="#F84136" d="M53.999 54l53.998 54H0l53.999-54z"></path>
            </svg>
          </div>
        </div>
          ...
          <ul className="w-full">
            {menuItems.map((item) => (
              <li
                ...
                onMouseEnter={() => item.id === 'products' && setIsHoveringProducts(true)}
                onMouseLeave={() => item.id === 'products' && setIsHoveringProducts(false)}
              >
        ...
        <div className="mt-auto w-full">
          <div className="flex flex-col items-center">
            <div className="py-3 text-gray-500 cursor-pointer hover:text-blue-500">
              <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
      ...
      {/* Products Sub Menu - Only shown on hover, not tied to active state */}
      <div
        className={`fixed left-0  top-0 h-screen bg-white border-r border-gray-200 w-64  shadow-md transition-transform duration-200 ease-in-out z-20 ${
          isHoveringProducts ? 'transform translate-x-0' : 'transform -translate-x-full'
        }`}
      ...
      >
        <div className="px-4 py-4 border-b border-gray-200">
          <div className="flex items-center">
            <svg height="16px" width="16px" viewBox="0 0 16 16" role="img" aria-label="ProductIcon" className="ui-icon mr-2 text-gray-500">
              <path fill="currentColor" fillRule="evenodd" d="M1.25 4A2.75 2.75 0 0 1 4 1.25h8A2.75 2.75 0 0 1 14.75 4v8A2.75 2.75 0 0 1 12 14.75H4A2.75 2.75 0 0 1 1.25 12zM4 2.75c-.69 0-1.25.56-1.25 1.25v1.25h10.5V4c0-.69-.56-1.25-1.25-1.25zm9.25 4H2.75V12c0 .69.56 1.25 1.25 1.25h8c.69 0 1.25-.56 1.25-1.25z" clipRule="evenodd"></path>
            </svg>
          ...
          <ul className="w-full">
            {productSubMenuItems.map((item) => (
              ...
              >
                ...
                {item.active && (
                  <div className="absolute left-0 w-1 h-10 bg-blue-500"></div>
                )}
              </li>
            ))}
          </ul>
