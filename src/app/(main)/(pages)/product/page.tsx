...
//    {/* Assuming Search is a React component rendering an SVG icon */}
...
//                               <svg height="16px" width="16px" viewBox="0 0 16 16" role="img" aria-label="ImportIcon" className="sc-fQpRED bUGbIN ui-icon"><path fill="currentColor" fill-rule="evenodd" d="M8 2.083a5.917 5.917 0 1 0 0 11.834A5.917 5.917 0 0 0 8 2.083M.583 8a7.417 7.417 0 1 1 14.833 0A7.417 7.417 0 0 1 .583 8m4.22-.53 2.666-2.667a.75.75 0 0 1 1.061 0l2.667 2.667a.75.75 0 1 1-1.061 1.06L8.75 7.144v3.523a.75.75 0 0 1-1.5 0V7.144L5.863 8.53a.75.75 0 0 1-1.06-1.06" clip-rule="evenodd"></path></svg>
//                         </button>
//                     </div>
//                 </header>
