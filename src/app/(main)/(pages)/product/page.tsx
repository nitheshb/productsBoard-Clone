...
import ProductDropdownPage from "@/app/(main)/(pages)/productDropdown/page";
        ...
        <div className="max-w-8xl mx-auto">
          <header className="flex justify-between items-center p-4">
            <div className="flex items-center gap-2">
              ...
              <ProductDropdownPage onProductSelect={handleProductsSelect} />
            </div>
            ...
            <div className="flex items-center gap-4">
              ...
              <button className="p-2 bg-white text-gray-400 rounded-md hover:bg-gray-100 transition duration-200">
                <svg
                  ...
                  viewBox="0 0 16 16"
                  role="img"
                  aria-label="ImportIcon"
                  className="sc-fQpRED bUGbIN ui-icon"
                >
                  <path
                    fill="currentColor"
                    fillRule="evenodd"
                    d="M8 2.083a5.917 5.917 0 1 0 0 11.834A5.917 5.917 0 0 0 8 2.083M.583 8a7.417 7.417 0 1 1 14.833 0A7.417 7.417 0 0 1 .583 8m4.22-.53 2.666-2.667a.75.75 0 0 1 1.061 0l2.667 2.667a.75.75 0 1 1-1.061 1.06L8.75 7.144v3.523a.75.75 0 0 1-1.5 0V7.144L5.863 8.53a.75.75 0 0 1-1.06-1.06"
                    clipRule="evenodd"
                  ></path>
                </svg>
              </button>
          ...
          <div className="flex items-center px-6 py-2 justify-between">
            ...
            >
              ...
              >
                <path
                  d="M8 2.583a.75.75 0 0 1 .75.75V7.25h3.916a.75.75 0 1 1 0 1.5H8.75v3.917a.75.75 0 0 1-1.5 0V8.75H3.333a.75.75 0 1 1 0-1.5H7.25V3.333a.75.75 0 0 1 .75-.75"
                  clipRule="evenodd"
                />
              </svg>
