...
//       try {
//         const response = await fetch(`/api/features/${featureId}?updateComponentProgress=true`, {
//           method: "DELETE",
//         });
//         if (!response.ok) {
//           const errorData = await response.json();
...
//       const updatedDraft = { 
//         ...draftFeature,
//         id: draftFeature?.id || featureId, // Ensure id is always defined
//         component_id: draftFeature?.component_id || "", // Ensure component_id is always defined
//         status: newStatus as Status,
//         progress: statusProgress,
...
//       setDraftFeature({
//         ...updatedDraft,
//         name: updatedDraft.name || "", // Ensure 'name' is always a string
//         team: updatedDraft.team || "", // Ensure 'team' is always a string
//         days: updatedDraft.days || 0, // Ensure 'days' is always a number
//         startDate: updatedDraft.startDate || "", // Ensure 'startDate' is always a string
//         targetDate: updatedDraft.targetDate || "", // Ensure 'targetDate' is always a string
//         completedOn: updatedDraft.completedOn || "", // Ensure 'completedOn' is always a string
//         remarks: updatedDraft.remarks || "", // Ensure 'remarks' is always a string
//         color: updatedDraft.color || "", // Ensure 'color' is always a string
//         created_at: updatedDraft.created_at || "", // Ensure 'created_at' is always a string
//       });
...
//       //   status: newStatus,
//       //   progress: statusProgress,
//       //   // Do not update component progress automatically
//       //   updateComponentProgress: false
//       // };
